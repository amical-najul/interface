    ...
    const handleSave = async (e) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                // Merge with existing session to keep token/unaltered fields
    ...
    const handleAvatarChange = async (e) => {
        ...
        try {
            ...
            if (res.ok) {
                ...
                const newSession = { ...user, avatar_url: data.avatar_url };
                localStorage.setItem('user', JSON.stringify(newSession));
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8">
                ...
                <div className="flex flex-col items-center mb-8">
                    <div className="relative group cursor-pointer" onClick={() => fileInputRef.current.click()}>
                        {user.avatar_url ? (
                            <img src={user.avatar_url} alt="Profile" className="w-24 h-24 rounded-full object-cover border-4 border-gray-100 group-hover:border-[#008a60] transition-colors" />
                        ) : (
